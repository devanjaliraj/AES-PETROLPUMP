...
class DealerListForPaymentModeLists extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/cashManagement/status/paymentModeLists/${params.data._id}`
                      )
                    }
                  />
                )}
...
export default DealerListForPaymentModeLists;
