...
class NetProfitList extends React.Component {
  state = {
    rowData: [],
  ...
  componentDidMount() {
    ...
    axiosConfig.get(`/dealer/allprofitApp/${id}`).then((response) => {
  ...
  async runthisfunction(id) {
    console.log(id);
    await axiosConfig.get(`/dealer/deleteprofit/${id}`).then((response) => {
