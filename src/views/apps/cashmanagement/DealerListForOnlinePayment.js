...
class DealerListForOnlinePayment extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/cashManagement/onlinePaymentList/${params.data._id}`
                      )
                    }
                  />
                )}
          ...
          <Row className="m-1">
            <Col>
              <h1 col-sm-6 className="float-left">
                List of Dealers for Online Payment
              </h1>
            </Col>
          </Row>
...
export default DealerListForOnlinePayment;
