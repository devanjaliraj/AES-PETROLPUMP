...
class DealerListForStatus extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/stockManagement/productReceiptList/${params.data._id}`
                      )
                    }
                  />
                )}
...
export default DealerListForStatus;
