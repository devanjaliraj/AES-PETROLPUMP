...
class DealerListForManager extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/staffEnrollment/managerList/${params.data._id}`
                      )
                    }
                  />
                )}
...
export default DealerListForManager;
