...
class DealerListForFuelStock extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/stockManagement/fuelStockList/${params.data._id}`
                      )
                    }
                  />
                )}
          ...
          <Row className="m-1">
            <Col>
              <h1 col-sm-6 className="float-left">
                List of Dealers for Fuel Stock
              </h1>
            </Col>
          </Row>
...
export default DealerListForFuelStock;
