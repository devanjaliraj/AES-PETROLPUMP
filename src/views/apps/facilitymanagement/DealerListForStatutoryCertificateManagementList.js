...
class DealerListForStatutoryCertificateManagementList extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/facilityManagement/statutoryCertificateManagementList/${params.data._id}`
                      )
                    }
                  />
                )}
...
export default DealerListForStatutoryCertificateManagementList;
