...
class DealerListForAddOtherDocument extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/facilityManagement/statutoryCertificateManagement/AddOtherDocument/${params.data._id}`
                      )
                    }
                  />
                )}
...
export default DealerListForAddOtherDocument;
