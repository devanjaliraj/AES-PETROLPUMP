...
class Thermometer extends React.Component {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              ...
              <img
                className=" rounded-circle  mr-3"
                src= {params.data.Upload_certificate}
                alt="user avatar"
                height="40"
                width="40"
              />
  ...
  componentDidMount() {
    ...
    axiosConfig.get(`/dealer/allthermometerFMApp/${id}`).then((response) => {
  ...
  async runthisfunction(id) {
    console.log(id);
    await axiosConfig.get(`/dealer/deletethermometerFM/${id}`).then((response) => {
