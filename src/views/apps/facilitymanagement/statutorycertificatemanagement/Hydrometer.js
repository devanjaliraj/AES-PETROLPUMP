...
class Hydrometer extends React.Component {
  ...
  componentDidMount() {
    ...
    axiosConfig.get(`/dealer/allhydrometerFMApp/${id}`).then((response) => {
  ...
  async runthisfunction(id) {
    console.log(id);
    await axiosConfig.get(`/dealer/deletehydrometerFM/${id}`).then((response) => {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Breadcrumbs breadCrumbTitle="Hydrometer" />
