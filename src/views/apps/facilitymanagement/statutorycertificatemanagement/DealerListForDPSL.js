...
class DealerListForDPSL extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/facilityManagement/statutoryCertificateManagement/DPSL/${params.data._id}`
                      )
                    }
                  />
                )}
...
export default DealerListForDPSL;
