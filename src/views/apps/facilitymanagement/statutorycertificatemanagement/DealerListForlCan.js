...
class DealerListFor5lCan extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/facilitymanagement/statutorycertificatemanagement/LCan/${params.data._id}`
                      )
                    }
                  />
                )}
...
export default DealerListFor5lCan;
