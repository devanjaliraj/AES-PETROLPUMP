...
class DealerListForFireEquipment extends React.Component {
  state = {
    rowData: [],
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Breadcrumbs breadCrumbTitle="Dealer List for Fire Equipment" />
...
export default DealerListForFireEquipment;
