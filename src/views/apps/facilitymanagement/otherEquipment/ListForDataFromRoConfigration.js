...
class ListForDataFromRoConfigration extends React.Component {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <span>{params.data.Equipment?.manufacturer}</span>
            </div>
          );
        },
      },
  ...
  componentDidMount() {
    ...
    axiosConfig.get(`/dealer/allequipmentApp/${id}`).then((response) => {
  ...
  async runthisfunction(id) {
    console.log(id);
    await axiosConfig.get(`/dealer/deleteequipment/${id}`).then((response) => {
...
export default ListForDataFromRoConfigration;
