...
class DealerListForCreditFromBankManagementList extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/facilityManagement/CreditFromBankManagementList/${params.data._id}`
                      )
                    }
                  />
                )}
...
export default DealerListForCreditFromBankManagementList;
