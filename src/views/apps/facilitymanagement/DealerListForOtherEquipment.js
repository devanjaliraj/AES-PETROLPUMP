...
class DealerListForOtherEquipment extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/facilityManagement/otherEquipmentList/${params.data._id}`
                      )
                    }
                  />
                )}
...
export default DealerListForOtherEquipment;
