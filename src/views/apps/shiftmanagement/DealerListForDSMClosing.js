...
class DealerListForDSMClosing extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/shiftManagement/dSMClosingSheetList/${params.data._id}`
                      )
                    }
                  />
                )}
          ...
          <Row className="m-1">
            <Col>
              <h1 col-sm-6 className="float-left">
                List of Dealers for DSM Closing Sheet
              </h1>
            </Col>
          </Row>
...
export default DealerListForDSMClosing;
