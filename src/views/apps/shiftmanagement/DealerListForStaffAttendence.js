...
class DealerListForStaffAttendence extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/shiftManagement/staffAttendanceList/${params.data._id}`
                      )
                    }
                  />
                )}
...
export default DealerListForStaffAttendence;
